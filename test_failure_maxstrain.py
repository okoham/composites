...
desired = {(-1, -1, -1): mat.F12s,  # shear strength
           (-1, -1,  0): mat.F22c/(1 - mat.nu21),  # transverse compressive strength
           ...
           (-1, 1, -1): mat.F22t/(1 - mat.nu12),  # transverse tensile strength
           (-1, 1,  0): mat.F22t/(1 - mat.nu21),  # transverse tensile strength
           (-1, 1,  1): mat.F22t/(1 - mat.nu12),  # transverse tensile strength
           ...
           (1, 1, -1): mat.F22t/(1 - mat.nu21),  # transverse tensile strength
           (1, 1,  0): mat.F22t/(1 - mat.nu21),  # transverse tensile strength
           (1, 1,  1): mat.F22t/(1 - mat.nu21),  # transverse tensile strength               
}
...
class _SimpleTest:
    ...
    def test_it(self):
        ...
        self.assertAlmostEqual(res.r, desired[self.load], places=4)
